...
const Form = () => {
    ...
    return (
        <div className="main-form-rs__form">
            {loading ?
                <>
                    <div className="main-form-thank">
                        <div className="main-form-rs__form-header">
                            <h4><Trans i18nKey="form.thank.header"/></h4>
                            <div className="main-form-rs__form-sub-header">
                                <Trans i18nKey="form.thank.subtitle"/>
                            </div>
                        </div>
                        <div type="button" className="yellow-btn" onClick={clear} ><Trans i18nKey="form.thank.btn"/></div>
                    </div>
                </>
                :
                <>
                    <div className="main-form-rs__form-header">
                        <h4><Trans i18nKey="form.title"/></h4>
                        <div className="main-form-rs__form-sub-header">
                    ...
                    <div className="main-form-rs__form-inner">
                        <form action="" className={"recover-form"}>
                            <div className="recover-form__input-row">
                                ...
                                <div className="recover-form__input-wrapper"
                                     style={width > 1216 ? {marginLeft: "16px"} : {}}>
